...
const items = [
    { icon: 'fab fa-instagram', link: 'https://instagram.com/hozpinar419' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/517023660972834847' },
    { icon: 'fab fa-spotify', link: 'https://sptfy.com/albayrakxel' },
  ]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">Hozpinar419</p>
